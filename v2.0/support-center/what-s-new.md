...
- {% badge type="info" text="Improvement" /%} **Export API**: The [GET - Exports project](/v2.0/api/ref#export-project) API now supports exporting a specific version.
...
- {% badge type="success" text="New" /%} **API**: New API to [lists all documentation section under a version](/v2.0/api/ref#list-documentation).
