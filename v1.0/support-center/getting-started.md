...
- Write however your team works: in the editor, [as code in a Git repository](github-sync.md), [from an AI client over MCP](ai-features/mcp-server/editor-mcp-server.md), or with the built-in [AI Agent](writing-documentation/ai-agent.md). It is all the same set of pages ✍️
