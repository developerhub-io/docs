...
To reorder, open the reference in our [API Editor](../edit-references.md) and edit the order of paths, operations, or tags directly in **Source** view; the reference re-renders in that order on save.
