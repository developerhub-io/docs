...
The search widget would use [AI Assistant](/support-center/ai-search) if it is enabled.
...
To apply your own `intercomSettings` for the widget, including if you wish to change the data region, then you can do so using [Custom HEAD Tags](/support-center/custom-javascript). Add a script tag that assigns the `intercomSettings` needed, such as:
