...
To embed a GraphiQL playground in a page, get the embed code from [embed.graphql.com](embed.graphql.com) and paste it into a [Custom HTML](/support-center/custom-html) block. For example:
...
You may even set this up in a [Custom Landing Page](/support-center/custom-landing-page) for full width experience. See [GraphQL Test](/graphql-test) for an example.
