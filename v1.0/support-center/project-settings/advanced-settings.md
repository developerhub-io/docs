...
{% tab language="javascript" %}
{
  ...
  code: {
    theme: "github-dark", // DEPRECATED - Use darkTheme and lightTheme
    darkTheme: 'github-dark', // Any theme from https://codemirror.net/demo/theme.html (must import CSS as well): Sets the dark theme for code blocks
    lightTheme: 'github-light', // Any theme from https://codemirror.net/demo/theme.html (must import CSS as well): Sets the light theme for code blocks
  ...
  apiReference: {
    ...
    setExampleAsValue: false // false|true: For API playground, sets the example as value
  },
  feedback: {
