...
- {% badge text="Improvement" /%} **Custom HTML**: HTML blocks that contain an iFrame no longer encapsulate around another iFrame.
...
- {% badge text="New" type="success" /%} **PDF Export**: Ability to modify front and back page covers from the UI.
- {% badge text="New" type="success" /%} **PDF Export**: Can use multiple back page covers now to add multiple PDFs to the docs PDF.
...
- {% badge text="Bug Fix" type="error" /%} **Editor**: Dropdowns had a very dark border in light mode.
- {% badge text="Bug Fix" type="error" /%} **Index**: Long connected page titles now break instead of getting hidden.

### 27 Jan

- {% badge text="New" type="success" /%} **PDF Export**: PDF export jobs can be removed from the list.

### 22 Jan

- {% badge text="Improvement" /%} **Callout**: Modernised callout looks by increasing border radius and removing shadow.
...
- {% badge text="Improvement" /%} **Editor**: Major improvements to copy \& paste behaviour. Copying and pasting DeveloperHub content always has content ordered correctly now. Select All performs as expected.
- {% badge text="Change" type="warning" /%} **Editor**: In edit mode, we no longer show a dotted box around the selected content, instead a line shows on the left side.

### 12 Jan

- {% badge text="New" type="success" /%} **PDF Export**: Both public and private projects can now be exported.
