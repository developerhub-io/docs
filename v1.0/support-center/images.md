...
You can upload images to your pages by using the Images uploader, or by simply pasting into the page. Your images are organised in the [Image Library](image-library.md), and can be re-used and centrally managed.
